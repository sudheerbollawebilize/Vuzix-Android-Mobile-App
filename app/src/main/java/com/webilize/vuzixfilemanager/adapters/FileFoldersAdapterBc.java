...
public class FileFoldersAdapterBc extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FileFoldersAdapterBc(Context context, ArrayList<FileFolderItem> fileFolderItemArrayList, IClickListener iClickListener) {
        ...
        if (getItemViewType(position) == 0) {
            ...
            if (fileFolderItem.isSelected) {
                ...
                if (listMode == AppConstants.SHOW_LIST) {
                    ((FoldersViewHolder) fileFoldersViewHolder).itemFolderBinding.txtFolderName.setGravity(Gravity.CENTER_VERTICAL);
                    ...
                    ((FoldersViewHolder) fileFoldersViewHolder).itemFolderBinding.txtFolderName.setGravity(Gravity.CENTER);
                    ((FoldersViewHolder) fileFoldersViewHolder).itemFolderBinding.txtFolderName.setCompoundDrawablesWithIntrinsicBounds(
                            null, ContextCompat.getDrawable(context, R.drawable.ic_select), null, null);
                }
            } else {
                ((FoldersViewHolder) fileFoldersViewHolder).itemFolderBinding.cardBody.setCardBackgroundColor(ContextCompat.getColor(context,
                        R.color.colorWhite));
