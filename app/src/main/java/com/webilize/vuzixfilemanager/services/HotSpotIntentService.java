...
public class HotSpotIntentService extends IntentService {
    ...
    /**
     * Helper method to start this intent from {@link com.webilize.vuzixfilemanager.receivers.HotSpotIntentReceiver}
     *
     * @param context
     * @param intent
     */
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ACTION_TURNON = AppConstants.ACTION_HOTSPOT_TURNON;
        ACTION_TURNOFF = AppConstants.ACTION_HOTSPOT_TURNOFF;

        DATAURI_TURNON = AppConstants.DATA_SCHEME_ON;
        DATAURI_TURNOFF = AppConstants.DATA_SCHEME_OFF;
    ...
    private Notification buildForegroundNotification() {
        ...
        stopIntent.setAction(AppConstants.ACTION_HOTSPOT_TURNOFF);
    ...
    private static void registerNotifChnnl(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            NotificationChannel channel = new NotificationChannel(
                    CHANNEL_ID,
                    AppConstants.HOTSPOT_NOTIFICATION_CHANNEL,
