 ...
 */
package com.webilize.pdfviewer.pdfviewer;
...
import com.webilize.pdfviewer.pdfviewer.exception.PageRenderingException;
import com.webilize.pdfviewer.pdfviewer.link.DefaultLinkHandler;
import com.webilize.pdfviewer.pdfviewer.link.LinkHandler;
import com.webilize.pdfviewer.pdfviewer.listener.Callbacks;
import com.webilize.pdfviewer.pdfviewer.listener.OnDrawListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnErrorListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnLoadCompleteListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnLongPressListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnPageChangeListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnPageErrorListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnPageScrollListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnRenderListener;
import com.webilize.pdfviewer.pdfviewer.listener.OnTapListener;
import com.webilize.pdfviewer.pdfviewer.model.PagePart;
import com.webilize.pdfviewer.pdfviewer.scroll.ScrollHandle;
import com.webilize.pdfviewer.pdfviewer.source.AssetSource;
import com.webilize.pdfviewer.pdfviewer.source.ByteArraySource;
import com.webilize.pdfviewer.pdfviewer.source.DocumentSource;
import com.webilize.pdfviewer.pdfviewer.source.FileSource;
import com.webilize.pdfviewer.pdfviewer.source.InputStreamSource;
import com.webilize.pdfviewer.pdfviewer.source.UriSource;
import com.webilize.pdfviewer.pdfviewer.util.Constants;
import com.webilize.pdfviewer.pdfviewer.util.FitPolicy;
import com.webilize.pdfviewer.pdfviewer.util.MathUtils;
import com.webilize.pdfviewer.pdfviewer.util.SnapEdge;
import com.webilize.pdfviewer.pdfviewer.util.Util;
...
public class PDFView extends RelativeLayout {
        ...
        if (nightMode) {
            ...
            ColorMatrix colorMatrixInverted =
                    new ColorMatrix(new float[]{
                            ...
                            0, 0, -1, 0, 255,
                            0, 0, 0, 1, 0});
            colorMatrixInverted.preConcat(matrixGrayScale);
    ...
    public void animateX(float nextX) {
        if(nextX != this.currentXOffset) {
            float max = Math.max(Math.abs(nextX), Math.abs(this.currentXOffset));
            float min = Math.min(Math.abs(nextX), Math.abs(this.currentXOffset));
            float diff = max - min;

            if(diff > 2) {
                Log.d(TAG, "animateX: " + this.currentXOffset + " to " + nextX + " diff " + diff);
...
//                }
                ...
                //moveTo(currentXOffset,getCurrentYOffset());
                animationManager.startXAnimation(this.currentXOffset, nextX, duration, true);
            }
        }
    }
    ...
    public void moveTo(float offsetX, float offsetY, boolean moveHandle) {
        ...
        Log.d(TAG, "animateX: X=" + currentXOffset );
    }

    public float getMaxOffsetX() {
        return getWidth() - pdfFile.getMaxPageWidth() * zoom;
    }
